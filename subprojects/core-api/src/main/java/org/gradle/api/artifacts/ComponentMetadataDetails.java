...
public interface ComponentMetadataDetails extends ComponentMetadata, HasConfigurableAttributes<ComponentMetadataDetails> {
    ...
    /**
     * Add a rule for adding new variant to the component. The new variant will be based on an
     * existing variant of the component and initialized with the same attributes and dependencies.
